        ...
        <main>
            <div class="row" id="Enanos">
                ...
                <div class="col-md-5 col-md-push-3 logo_clase">
                    <img src="/imagenes/wizard.png" width="50%" class="animated rubberBand">
                </div>
            </div>

            <div class="row" id="contenido_mago">
                <div class="row">
                    <div class="col-md-6">
                        <p >
                ...
                <div class="row">
                    <div class="col-md-8 col-md-offset-2">
                        <iframe width="100%" height="50%" src="https://www.youtube.com/embed/SfSbe0ECBnE"></iframe>
